...
exports.users = (0, pg_core_1.pgTable)('users', {
    ...
    line_id: (0, pg_core_1.varchar)('line_id', { length: 100 }).notNull().unique(),
...
exports.pkceSessions = (0, pg_core_1.pgTable)('pkce_sessions', {
    state: (0, pg_core_1.varchar)('state', { length: 100 }).primaryKey(), // OAuth state参数，用作主键
    verifier: (0, pg_core_1.varchar)('verifier', { length: 100 }).notNull(), // PKCE code_verifier
    nonce: (0, pg_core_1.varchar)('nonce', { length: 100 }).notNull(), // OpenID nonce
    return_path: (0, pg_core_1.varchar)('return_path', { length: 500 }).default('/'), // 登录后返回路径
