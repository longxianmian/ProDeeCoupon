  ...
  <div class="admin-dashboard">
    ...
    <el-aside width="250px" class="sidebar">
      <div class="logo-section">
        ...
        <h3 class="brand-title">PreDee Admin</h3>
      </div>
      ...
      >
        <el-menu-item index="/admin/dashboard" @click="setActiveMenu('/admin/dashboard')">
        ...
        <el-sub-menu index="business">
          ...
          <el-menu-item index="/admin/stores" @click="setActiveMenu('/admin/stores')">
            <span>{{ $t('admin.menu.storeManagement') }}</span>
          </el-menu-item>
          <el-menu-item index="/admin/campaigns" @click="setActiveMenu('/admin/campaigns')">
            <span>{{ $t('admin.menu.activityManagement') }}</span>
          </el-menu-item>
          <el-menu-item index="/admin/redemptions" @click="setActiveMenu('/admin/redemptions')">
        ...
        <el-sub-menu index="data">
          ...
          <el-menu-item index="/admin/analytics" @click="setActiveMenu('/admin/analytics')">
            <span>{{ $t('admin.menu.dataStatistics') }}</span>
          </el-menu-item>
          <el-menu-item index="/admin/users" @click="setActiveMenu('/admin/users')">
            <span>{{ $t('admin.menu.userManagement') }}</span>
          </el-menu-item>
        </el-sub-menu>
        
        <el-menu-item index="/admin/settings" @click="setActiveMenu('/admin/settings')">
        ...
        <div class="welcome-section">
          <div class="welcome-content">
            <div class="welcome-text">
              <h2 class="welcome-title">{{ $t('admin.welcome') }}，{{ adminInfo.name || adminInfo.email }}！</h2>
...
import { 
  ...
  Promotion, DocumentChecked, Management, SwitchButton
